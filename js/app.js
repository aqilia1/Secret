...
const sttaddr = "0x76619bc548B30C58e4cDe05Cc60661029d352e3a";
const sttabi = [{
  "inputs": [],
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0x76619bc548B30C58e4cDe05Cc60661029d352e3a";
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0x76619bc548B30C58e4cDe05Cc60661029d352e3a',
          'symbol': 'SCC',
          'decimals': '18',
...
var countDownDate = new Date("January 30, 2022 15:37:25").getTime();
